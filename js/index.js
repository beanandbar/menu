...
function addMenuInfo(store) {
  ...
  if (social) {
    ...
    if (social.instagramUrl) {
      socialDiv.innerHTML += `
        <a href="${social.instagramUrl}" target="_blank" title="Instagram" aria-label="Instagram">
    ...
    if (social.facebookUrl) {
      socialDiv.innerHTML += `
        <a href="${social.facebookUrl}" target="_blank" title="Facebook" aria-label="Facebook">
